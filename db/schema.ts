...
export const polls = pgTable(
  "polls",
  {
    ...
    createdAnonymous: boolean("created_anonymous").notNull().default(false),
    organizerLinkCopiedAt: timestamp("organizer_link_copied_at", { withTimezone: true }),
    claimedAt: timestamp("claimed_at", { withTimezone: true }),
    organizerLinkOpenCount: integer("organizer_link_open_count").notNull().default(0),
